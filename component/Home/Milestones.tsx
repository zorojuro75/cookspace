...
const Milestones = () => {
  return (
    <div className="flex flex-col items-center justify-center max-w-[90rem] mx-auto py-20 px-6 md:px-10 gap-10">
      <div className="text-center">
        <h2 className="text-4xl md:text-6xl font-bold text-white">
          Our Latest Tech Milestones
        </h2>
        <h3 className="text-lg md:text-xl text-gray-400 mt-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
        {milestones.map((item, idx) => (
          <div
            key={idx}
            className="bg-[#0d0d0d] rounded-2xl p-10 border border-gray-800"
          >
            <div className="relative h-[320px] w-full rounded-xl overflow-hidden bg-black group border-gray-700 border">
        ...
        {/* Coming Soon Card */}
        <div className="rounded-2xl p-10 bg-gradient-to-br from-[#0f1123] via-[#191933] to-[#281b30] border border-purple-700 shadow-[0_0_30px_rgba(255,255,255,0.05)] flex items-center justify-center text-center min-h-[300px]">
          <div>
